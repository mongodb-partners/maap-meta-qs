...
async def LoadFiles(file_names: List[str], userId) -> List[Document]:
    ...
    for doc in docs:
        ...
        doc.metadata["timestamp"] = datetime.now(timezone.utc)
...
async def LoadWeb(urls: List[str], userId) -> List[Document]:
    docs = []
